...
public enum SoundInfo {
    ...
    BONGA("Bonga", "soundEffects/battle/Bonga.ogg"),
    BOOM("Boom", "soundEffects/battle/Boom.ogg"),
    BOOM_DECAY("Boom Decay", "soundEffects/battle/BoomDecay.ogg"),
    BOOM_WAVE("Boom Wave", "soundEffects/battle/BoomWave.ogg"),
    BOOST_WAVE("Boost Wave", "soundEffects/battle/BoostWave.ogg"),
    ...
    HIGH_BUFF("High Buff", "soundEffects/battle/HighBuff.ogg"),
    ...
    LOW_BUFF("Low Buff", "soundEffects/battle/LowBuff.ogg"),
    MINI_STAR_WOOSH("Mini Star Woosh", "soundEffects/battle/MiniStarWoosh.ogg"),
    MONK_DOWN("Monk DOwn", "soundEffects/battle/MonkDown.ogg"),
    MYSTERY("Mystery", "soundEffects/battle/Mystery.ogg"),
    NOTE("Note", "soundEffects/battle/Note.ogg"),
    OMEN("Omen", "soundEffects/battle/Omen.ogg"),
    ...
    SPACE_CLAW("Space Claw", "soundEffects/battle/SpaceClaw.ogg"),
    ...
    SUPRISE("Suprise", "soundEffects/battle/Suprise.ogg"),
