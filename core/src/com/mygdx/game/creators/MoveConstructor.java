...
public class MoveConstructor {
    ...
    public static Move guardPiercer(Entity user) {
        ...
        VisualEvent circles = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(glow);
                if (timesPlayed % 3 == 0) soundManager.playSound(SoundInfo.VOOM, 2f, -999, -999);
            }
    ...
    public static Move bark(Entity user) {
        //Visuals---
        VisualEvent noiseCurious = new VisualEvent(new VisualEffect() {
            BoardPosition bp;
            Tile t;
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.CURIOUS);
            }
        }, .01f, 1);
        ...
        VisualEvent bark2 = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(zigzag);
                soundManager.playSound(SoundInfo.SPIRAL, 2, -0.1f, 0.4f);
            }
        }, .5f, 1);
        ...
        Move move = new Move("Bark", nm.get(user).name + " barked intimidatingly!", user, 2, new Array<BoardPosition>(new BoardPosition[]{new BoardPosition(-1, 0)}),
                ...
                new Array<VisualEvent>(new VisualEvent[]{noiseCurious, bark.copy(.1f), bark2.copy(.1f), bark.copy(.1f), bark2.copy(.1f) ,bark, bark2})), new MoveInfo(false, 0, petrify(2).createStatusEffectInfo()));
        move.setAttackDescription("Barks intimidatingly at the opponent. Petrifies the target for 2 turns.");
        return move;
    }
    ...
    public static Move yelp(Entity user) {
        ...
        VisualEvent noiseCurious = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.CURIOUS, 1.2f, 0, 1);
            }
        }, .01f, 1);
        ...
        VisualEvent bark2 = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(zigzag);
                soundManager.playSound(SoundInfo.SPIRAL, 1.8f, -0.1f, 0.4f);
            }
        }, .5f, 1);
        ...
        Move move = new Move("Yelp", nm.get(user).name + " yelped cutely!", user, 2, new Array<BoardPosition>(new BoardPosition[]{new BoardPosition(-1, 0)}),
                ...
                new Array<VisualEvent>(new VisualEvent[]{noiseCurious, bark.copy(.1f), bark2.copy(.1f), bark.copy(.1f), bark2.copy(.1f) ,bark, bark2})), new MoveInfo(false, 0, defenseless(3).createStatusEffectInfo(), offenseless(3).createStatusEffectInfo()));
        move.setAttackDescription("Yelps in order to lower the opponents guard. Brings the target's defense to 0 and halves their attack for 3 turns.");
        return move;
    }
    ...
    public static Move laserSpray(Entity user) {
        VisualEvent laserNoise = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.LASER, 0.8f, 0, 0.2f);
            }
        }, .01f, 1);

        VisualEvent explosionNoise = new VisualEvent(new VisualEffect() {
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                soundManager.playSound(SoundInfo.BOOM_DECAY, 1f, 0, 0.8f);
            }
        }, .01f, 1);
        ...
        Move move = new Move("Laser Spread", nm.get(user).name + " sprayed laser beams!", user, 4,
                ...
                new BoardPosition(-2, 1), new BoardPosition(-2, 0), new BoardPosition(-2, -1),
                new BoardPosition(-3, 2), new BoardPosition(-3, 1), new BoardPosition(-3, 0), new BoardPosition(-3, -1), new BoardPosition(-3, -2)}),
                new Array<VisualEvent>(new VisualEvent[]{laserNoise, laser, explosionNoise, explode})), new MoveInfo(false, 1));
    ...
    public static Move sear(Entity user) {
        VisualEvent fireNoise = new VisualEvent(new VisualEffect() {
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                soundManager.playSound(SoundInfo.FIRE_BURNING);
            }
        ...
        Move move = new Move("Sear", null, user, 2, new Array<BoardPosition>(new BoardPosition[]{new BoardPosition(-1, 0)}),
                ...
                new Array<VisualEvent>(new VisualEvent[]{fireNoise, fire})), new MoveInfo(false, 0, burn(3).createStatusEffectInfo()));
    ...
    public static Move chill(Entity user) {
        VisualEvent freeze = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.STAR_WOOSH, 2, 0, 1);
            }
        }, .5f, 1);
    ...
    public static Move tailwind(Entity user) {
        VisualEvent windNoise = new VisualEvent(new VisualEffect() {
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                soundManager.playSound(SoundInfo.SWIRL_WIND, 1.6f, 0, 0.4f);
            }
        }, .01f, 1);

        VisualEvent buffNoise = new VisualEvent(new VisualEffect() {
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                soundManager.playSound(SoundInfo.BUFF, 1.5f, 0, 1);
            }
        }, .01f, 1);
    ...
    public static Move twister(Entity user) {
        ...
        VisualEvent explode = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(boom);
                soundManager.playSound(SoundInfo.BOOM_DECAY, 1.4f, 0, 0.9f);
            }
        }, .3f, 3);
        ...
        VisualEvent flash = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.SWIRL_WIND);
        ...
        Move move = new Move("Twister", user, 3, new Array<BoardPosition>(new BoardPosition[]{
                ...
                new BoardPosition(-3, 1), new BoardPosition(-3, -1),
                new BoardPosition(-2, 0), new BoardPosition(-4, -0)}),
                new Array<VisualEvent>(new VisualEvent[]{flash, shuriken, sparkle, explode})), new MoveInfo(true, 1.5f));
        move.setAttackDescription("Summons a vicious twister. Ignores the targets defence and deals 1.5x damage.");
        return move;
    }
    ...
    public static Move freezeAttack(Entity user) {
        VisualEvent freeze = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.WARP_FAST, 1.3f, 0, 0.6f);
            }
        }, .7f, 1);
        ...
        VisualEvent sparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                if (timesCalled % 2 == 0) {
                    soundManager.playSound(SoundInfo.DRIPPING, MathUtils.random(1.7f, 2), 0, 1);
                }
            }
        }, .2f, 9);
    ...
    public static Move assist(Entity user) {
        VisualEvent explode = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.BUFF, 2, 0, 1);
            }
        }, .01f, 1);
        ...
        VisualEvent sparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.BUBBLE);
            }
        }, .19f, 9);
    ...
    public static Move recover(Entity user) {
        ...
        VisualEvent sparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.BUBBLE, 1.1f, 0, 1);
            }
        }, .19f, 9);
    ...
    public static Move submerge(Entity user) {
        ...
        VisualEvent ripples = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.BUBBLE2, 0.5f, 0, 1);
            }
        }, .19f, 4);
        ...
        VisualEvent waterBall = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.DRIPPING, 0.5f, 0, 1);
            }
        }, .2f, 1);
        ...
        VisualEvent largeSparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                soundManager.playSound(SoundInfo.BUBBLE, MathUtils.random(0.5f, 0.6f), 0, 1);
            }
        }, .15f, 6);
    ...
    public static Move restMind(Entity user) {
        ...
        VisualEvent sparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.MINI_STAR_WOOSH, 2, 0.35f * (timesCalled % 2) * 2 - 1, 0.8f);
            }
        }, .14f, 9);
        ...
        VisualEvent explode = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                boom.add(new EventComponent(.03f, true, EventCompUtil.fadeOut(5)));
                engine.addEntity(boom);
                soundManager.playSound(SoundInfo.ZEP, 2, 0, 1);
            }
        }, .01f, 1);
        ...
        VisualEvent returnToNormal = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                am.get(user).actor.shade(BattleScreen.getShadeColorBasedOnState(user));
                soundManager.playSound(SoundInfo.SPACE_OUT, 1.5f, 0, 1);
            }
        }, .05f, 1);
    ...
    public static Move drench(Entity user) {
        VisualEvent sparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                if (MathUtils.randomBoolean(0.3f)) {
                    soundManager.playSound(SoundInfo.BUBBLE, MathUtils.random(0.5f, 0.9f), -999, -999);
                } else {
                    if (MathUtils.randomBoolean(0.5f)) {
                        soundManager.playSound(SoundInfo.DRIPPING, MathUtils.random(0.5f, 0.9f), -999, -999);
                    }
                }
            }
        }, .19f, 9);
        ...
        VisualEvent ripple = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                boom.add(new EventComponent(.06f, true, EventCompUtil.fadeOut(5)));
                engine.addEntity(boom);
                soundManager.playSound(SoundInfo.BUBBLE_BURST, 0.7f, 0, 1);
            }
        }, .1f, 1);
        ...
        VisualEvent largeSparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                soundManager.playSound(SoundInfo.DRIPPING, 0.7f, 0, 1);
            }
        }, .01f, 7);
    ...
    public static Move electrocute(Entity user) {
        ...
        VisualEvent spinning = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.LASER_ALT, .7f, 0, 0.3f);
            }
        }, 2f, 1);
        ...
        VisualEvent ripple = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.STATUS_ZAP, 1.6f, 0, 1);
            }
        }, .25f, 2);
        ...
        VisualEvent largeSparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                soundManager.playSound(SoundInfo.MINI_STAR_WOOSH, 1.9f, 0, 1);
            }
        }, .01f, 7);
    ...
    public static Move cometShower(Entity user) {
        ...
        VisualEvent preSparkles = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                soundManager.playSound(SoundInfo.BOOM, 1.3f, 0, 1);
            }
        }, .04f, 5);
        ...
        VisualEvent comets = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.STAR_WOOSH);
            }
        }, .05f, 8);
                    ...
                    public void effect(Entity e, BoardPosition bp) {
                        ...
                        if (status.has(enemy)) {
                            if (!status.get(enemy).contains("Paralyze")) { //Not paralyzed
                                ...
                                stm.get(e).sp = MathUtils.clamp(stm.get(e).sp + 2, 0, stm.get(e).maxSP); //recover sp
                            }
                        }
    ...
    public static Move charge(Entity user) {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                if (timesCalled % 3 == 0) {
                    if (MathUtils.randomBoolean()) {
                        ...
                        soundManager.playSound(SoundInfo.MINI_STAR_WOOSH, 1.6f, 0, 1);
                    }
                }
            }
        }, .03f, 30);
        ...
        VisualEvent returnToNormal = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                am.get(user).actor.shade(BattleScreen.getShadeColorBasedOnState(user));
                soundManager.playSound(SoundInfo.STATUS_ZAP, 1.5f, 0, 1);
            }
        }, .05f, 1);
    ...
    public static Move superCharge(Entity user) {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                if (timesCalled % 3 == 0) {
                    if (MathUtils.randomBoolean(.35f)) {
                        soundManager.playSound(SoundInfo.BUBBLE, 0.8f, 0, 1);
                    } else {
                        soundManager.playSound(SoundInfo.MINI_STAR_WOOSH, 1.25f, 0, 1);
                    }
                }
            }
        }, .02f, 90);
        ...
        VisualEvent returnToNormal = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                am.get(user).actor.shade(BattleScreen.getShadeColorBasedOnState(user));
                soundManager.playSound(SoundInfo.STATUS_ZAP, 1.2f, 0, 1);
            }
        }, .05f, 1);
    ...
    public static Move voltDeluge(Entity user) {
        ...
        VisualEvent ions = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                if (timesCalled % 7 == 0) {
                    soundManager.playSound(SoundInfo.BUBBLE2, MathUtils.random(1.5f, 2), 0, 1);
                    soundManager.playSound(SoundInfo.VOOM, MathUtils.random(1.8f, 2), 0, 0.3f);
                }
            }
        }, .02f, 100);
        ...
        VisualEvent shocking = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.CURIOUS);
                soundManager.playSound(SoundInfo.STATUS_ZAP, 0.9f, 0, 1);
            }
        }, .1f, 2);

        Move move = new Move("Volt Deluge", user, 3, new Array<BoardPosition>(new BoardPosition[]{
                ...
                new Attack() {
                    ...
                    public void effect(Entity e, BoardPosition bp) {
                        ...
                        if (status.has(enemy) && MathUtils.randomBoolean(.6f)) {
                            status.get(enemy).addStatusEffect(paralyze(3), enemy);
                        }
                        if (status.has(enemy) && MathUtils.randomBoolean(.6f)) {
                            status.get(enemy).addStatusEffect(defenseless(3), enemy);
    ...
    public static Move barrage(Entity user) {
        VisualEvent barrage = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.HIT, MathUtils.random(0.9f, 1.1f), 0, 1);
            }
        }, .1f, 5);
    ...
    public static Move feint(Entity user) {
        ...
        VisualEvent noise = new VisualEvent(new VisualEffect() {
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                soundManager.playSound(SoundInfo.HUNGER, 1, 0, 3);
            }
        }, .01f, 1);
    ...
    public static Move basiliskPunch(Entity user) {
        VisualEvent barrage = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(fist);
                soundManager.playSound(SoundInfo.HIT, 0.6f, 0, 1);
            }
        }, .1f, 1);
        ...
        VisualEvent bubble = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(bubble);
                soundManager.playSound(SoundInfo.BUBBLE2, 0.6f, 0, 1);
            }
        }, .19f, 2);
    ...
    public static Move curseAttack(Entity user) {
        VisualEvent sounds = new VisualEvent(new VisualEffect() {
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                soundManager.playSound(SoundInfo.SLIDE_DOWN, 0.7f, 0, 0.5f);
                soundManager.playSound(SoundInfo.BEEP_DECAY, 1f, 0, 0.7f);
                soundManager.playSound(SoundInfo.RINGING);
            }
        }, 0f, 1);
        ...
        VisualEvent spinningDiamond = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                diamond.add(new PositionComponent(tilePosition.cpy().add(MathUtils.random(-50 * scale, 30 * scale), MathUtils.random(-50 * scale, 20 * scale)),
                        entitySize.x, entitySize.y, 0));
                diamond.add(new MovementComponent(new Vector2(0, 15 * scale)));
                diamond.add(new LifetimeComponent(0, 1.5f));
                Sprite sprite = new Sprite(atlas.findRegion("diamondBoom5"));
                sprite.setOriginCenter();
                sprite.setColor(Color.GREEN);
                diamond.add(new SpriteComponent(sprite));
                diamond.add(new EventComponent(.1f, true, (entity, engine) -> {
                    Sprite spr = sm.get(entity).sprite;
                    spr.setColor(
                            spr.getColor().r,
                            spr.getColor().g,
        ...
        Move move = new Move("Curse", nm.get(user).name + " placed a curse.", user, 5, new Array<BoardPosition>(new BoardPosition[]{new BoardPosition(-1, 0)}),
                ...
                new Array<VisualEvent>(new VisualEvent[]{sounds, fire, spinningDiamond.copy(), sparkle.copy(), spinningDiamond, sparkle})), new MoveInfo(false, 0, curse(3).createStatusEffectInfo()));
    ...
    public static Move restBody(Entity user) {
        ...
        VisualEvent sparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.MINI_STAR_WOOSH, 1.9f, 0.35f * (timesCalled % 2) * 2 - 1, 0.8f);
            }
        }, .14f, 9);
        ...
        VisualEvent explode = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                boom.add(new EventComponent(.03f, true, EventCompUtil.fadeOut(5)));
                engine.addEntity(boom);
                soundManager.playSound(SoundInfo.ZEP, 1.9f, 0, 1);
            }
        }, .01f, 1);
    ...
    public static Move cometShowerClose(Entity user) {
        ...
        VisualEvent preSparkles = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                soundManager.playSound(SoundInfo.BOOM, 1.7f, 0, 1);
            }
        }, .04f, 5);
        ...
        VisualEvent comets = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(comet);
                if (timesCalled % 2 == 0) {
                    soundManager.playSound(SoundInfo.STAR_WOOSH, MathUtils.random(1f, 1.3f), 0, 1);
                }
            }
        }, .035f, 12);
        ...
        VisualEvent ripple = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                if (MathUtils.randomBoolean()) {
                    soundManager.playSound(SoundInfo.FANCY_BOOM, MathUtils.random(0.8f, 1.2f), 0, 1);
                } else {
                    soundManager.playSound(SoundInfo.BOOM_DECAY, MathUtils.random(0.8f, 1.2f), 0, 1);
                }
            }
        }, .2f, 2);
    ...
    public static Move dragonBreath(Entity user) {
        ...
        VisualEvent noise = new VisualEvent(new VisualEffect() {
            @Override
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                soundManager.playSound(SoundInfo.CLAW, 1.4f, 0, 1);
            }
        }, 0f, 1);
    ...
    public static Move restore(Entity user) {
        VisualEvent largeSparkle = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                if (timesCalled % 2 == 0) {
                    soundManager.playSound(SoundInfo.PING, MathUtils.random(1.4f, 2f), 0, 0.6f);
                }
            }
        }, .06f, 4);
        ...
        VisualEvent circles = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                if (timesCalled % 3 == 0) {
                    soundManager.playSound(SoundInfo.BUBBLE2, 0.9f, 0, 1);
                }
            }
        }, .035f, 9);
        ...
        VisualEvent returnToNormal = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.BLIP_UP);
                soundManager.playSound(SoundInfo.ZEP);
            }
        }, .05f, 1);
    ...
    public static Move regen(Entity user) {
        VisualEvent regenParticles1 = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                soundManager.playSound(SoundInfo.PING, MathUtils.random(1.1f, 2f), 0, 0.6f);
            }
        }, .1f, 4);
        ...
        VisualEvent returnToNormal = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                Entity enemy = boards.getCodeBoard().get(bp.r, bp.c);
                am.get(enemy).actor.shade(BattleScreen.getShadeColorBasedOnState(enemy));
                soundManager.playSound(SoundInfo.CURIOUS, 1.3f, 0, 1);
            }
        }, .05f, 1);
    ...
    public static Move boost(Entity user) {
        VisualEvent regenParticles1 = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(sparkle);
                soundManager.playSound(SoundInfo.PING, MathUtils.random(1.1f, 2f), 0, 1);
            }
        }, .1f, 4);
        ...
        VisualEvent ripple = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                boom.add(new EventComponent(.06f, true, EventCompUtil.fadeOut(5)));
                engine.addEntity(boom);
                soundManager.playSound(SoundInfo.VOOM, 1.5f, 0, 1);
            }
        }, .25f, 2);
    ...
    public static Move reflectMove(Entity user) {
        ...
        VisualEvent mirror = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                soundManager.playSound(SoundInfo.WARP_FAST, 1, 0, 0.5f);
    ...
    public static Move peck(Entity user) {
        VisualEvent bash = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                engine.addEntity(bam);
                soundManager.playSound(SoundInfo.BOOM, 1.4f, 0, 1);
            }
        }, .08f, 6);
    ...
    public static Move vigorate(Entity user) {
        ...
        VisualEvent fire = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                for (BoardPosition pos : targetPositions) {
                    ...
                    timesCalled++;
                    if (timesCalled % 3 == 0) {
                        soundManager.playSound(SoundInfo.FIRE_START, 1, 0, 0.25f);
                    }
                }
            }
        }, .06f, 15);
        ...
        Move move = new Move("Vigorate", nm.get(user).name + " gave the target a powerful energy.", user, 4, new Array<BoardPosition>(new BoardPosition[]{new BoardPosition(-1, 0)}),
                ...
                new MoveInfo(false, 0, attackUp(4).createStatusEffectInfo()));
        move.setAttackDescription("Uses spare energy to grant the target a powerful energy. Increases the target's attack for 4 turns.");
        return move;
    }
    ...
    public static Move selfPurge(Entity user) {
        ...
        VisualEvent explode = new VisualEvent(new VisualEffect() {
            ...
            public void doVisuals(Entity user, Array<BoardPosition> targetPositions) {
                ...
                boom.add(new EventComponent(.03f, true, EventCompUtil.fadeOut(5)));
                engine.addEntity(boom);
                soundManager.playSound(SoundInfo.DEEP, 1.6f, 0, 1);
            }
        }, .01f, 1);
        ...
        move.setAttackDescription("The flames in its body burn hotter, removing any negative status effects.");
        return move;
    }
